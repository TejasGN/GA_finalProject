        ...
        <section className="second-wrap" id="about">
            <div className="grid">
                <div className="abt-wrap">
                    <div className="left-wrap">
                        <img
                            ...
                            className="me-img"
                            alt="Tejas Nashikkar - software developer"
                        />
                        <div className="social-wrap">
                            <a
                                href="https://www.facebook.com/tejas.nashikkar7/"
                                target="_blank"
                            >
                                <img src="images/fb.png" alt="facebook-img" />
                            </a>
                            <a
                                href="https://www.linkedin.com/in/tejas-nashikkar-60b5b4155"
                                target="_blank"
                            >
                                <img
                            ...
                            <a
                                href="https://www.instagram.com/invites/contact/?i=za9tatt7fvgz&utm_content=ai1n7x"
                                target="_blank"
                            >
                                <img
                    ...
                    <div className="right-wrap">
                        ...
                        <div className="desc-txt">
                            Hi, I am Tejas Nashikkar, a Frontend Developer
                            living in{" "}
                            <a
                            ...
                            experience of working in React, Angular and
                            AngularJS frameworks for the frontend and also
                ...
                <div className="nums-wrap">
                    ...
                    <div className="num">
                        <h4 className="count" data-count="5570">
                            0
                        </h4>
                        <p>hours Dota2 played</p>
                    </div>
                    <div className="num">
                        <h4 className="count" data-count="6">
                            0
                        </h4>
